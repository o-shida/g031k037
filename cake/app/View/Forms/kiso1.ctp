...
しｋし、新規にフレームワークを構築することは、リスクが大きく、多大な投資となる<br>
既存のフレームワークを使うと、フレームワーク構築のリスクをとらず、
構築するよりもすくなり当市で、フレームワークのメリットを享受が可能。
<br><br>
<h5>デメリット</h5>
...
<h5>※フレームワーク病とは</h5>
フレームワークを使用したアプリケーションの拡張は、フレームワークが提供する拡張の仕組みに従った形で行う必要があります。<br>その拡張の仕組みが仏雑であればあるほど、アプリケーションの拡張にかかるコストが大きくなってしまいます。拡張の仕組みが複雑なフレームワークでは，ほんの少しの拡張であったとしても，拡張コードそのものを書く時間よりも，その仕組みに従った形にすることに，より多くの時間が掛かってしまうことになりかねません。これが「フレームワーク病」の症状なのです。<br>
<br>
コンテンツ管理システム（CMS）といわれるものがあります。これは，多くの場合フレームワークを内包し，フレームワークよりもさらに大きな再利用の仕組みを提供するはずのものです。しかし，多くのCMSがこれまで成功を収めていないという事実は，フレームワーク病の存在を示唆しているといえるでしょう。<br>
<br>
<br>
<h3>PHPフレームワーク</h3>
<h2>Leravel</h2>
Laravelは柔軟性と読み書きしやすさを重視した、パワフルなフレームワークである。<br>
Laravelには他のフレームワークと違った特徴を数多く持っている。<br>
<h5>バンドル</h5>：Laravelのモジュールパッキングシステムである。 <br>
Laravelバンドルリポジトリー は、アプリケーションへ簡単に機能を付け加えられるように、予め用意されている。 バンドルリポジトリーからbundlesディレクトリーにダウンロードしても良いですし、"Artisan"コマンドラインツールを使い、自動的にインストールすることもできます。<br>
